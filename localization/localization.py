...
class Localization:
    ...
    'common.help.device':{
                ...
                'tr-TR' : 'Modül aygıtlarının kombinasyonunu düzenleyerek daha yüksek fps veya daha düşük CPU kullanım oranını elde edin.'},
    ...
    'QFileSource.help.fps':{
                ...
                'tr-TR' : 'İstenen kare hızını ayarlayın.'},
    ...
    'QFileSource.help.is_realtime':{
                ...
                'tr-TR' : 'Gerçek zamanlı FPS ile mi yoksa mümkün olduğunca hızlı mı oynatılacağı.'},
    ...
    'QCameraSource.help.driver':{
                ...
                'tr-TR' : 'Kamerayı çalıştırmak için işletim sistemi sürücüsü.\nBazı sürücüler daha yüksek çözünürlüğü destekleyebilir ancak üretici ayarlarını desteklemez.'},
    ...
    'QCameraSource.help.fps':{
                ...
                'tr-TR' : 'Kamera cihazının saniyede çıkardığı kare sayısı.'},
    ...
    'QFaceDetector.help.detector_type':{
                ...
                'tr-TR' : 'Farklı algılayıcı türleri farklı çalışır.'},
    ...
    'QFaceDetector.help.window_size':{
        ...
        'tr-TR' : 'Daha küçük pencere boyutu daha hızlıdır, ancak daha az doğrudur.'},
    ...
    'QFaceDetector.help.threshold':{
        ...
        'tr-TR' : 'Değer ne kadar düşükse o kadar çok yanlış yüz tespit edilir.'},
    ...
    'QFaceDetector.help.max_faces':{
        ...
        'tr-TR' : 'Tespit edilecek maksimum yüz sayısı.'},
    ...
    'QFaceDetector.help.sort_by':{
        ...
        'tr-TR' : '"SAĞDAN SOLA" gibi bir yöntemle yüzleri sırala. Örneğin, Face ID 0 ekranın en sağında olur.'},
    ...
    'QFaceDetector.help.temporal_smoothing':{
        ...
        'tr-TR' : 'Yüz dikdörtgenini kareler üzerinden ortalamayla sabitler.\nStatik sahneler veya web kamerası için uygundur.'},
    ...
    'QFaceAligner.help.align_mode':{
        ...
        'tr-TR' : 'Dikdörtgenden gelen veriler Yüz Animatörü için uygundur. Noktalardan gelen veriler yüz değiştirici için uygundur.'},
    ...
    'QFaceAligner.help.face_coverage':{
        ...
        'tr-TR' : 'Hizalanmış yüzün çıktı alanı.\nİstediğiniz gibi ayarlayın.'},
    ...
    'QFaceAligner.help.resolution':{
        ...
        'tr-TR' : 'Hizalanmış yüzün çözünürlüğü.\nModel çözünürlüğüyle eşleşmelidir.'},
    ...
    'QFaceAligner.exclude_moving_parts':{
        ...
        'tr-TR' : 'Hareketli parçaları hariç tut'},
    ...
    'QFaceAligner.help.exclude_moving_parts':{
        ...
        'tr-TR' : 'Ağız gibi yüzün hareket eden parçalarına ait işaret noktalarını hariç tutarak stabilizasyonu artırır.'},
    ...
    'QFaceMarker.help.marker_type':{
        ...
        'tr-TR' : 'Yüz işaretleyicisinin türü.'},
    ...
    'QFaceMarker.help.marker_coverage':{
        ...
        'tr-TR' : 'FaceMarker\'a girdi olarak gönderilecek algılanan yüzün dikdörtgen boyutunu kontrol eder.\nYeşil yüz noktaları yüze tam olarak uymalıdır.\n"Hizalanmış Yüz" penceresine bakın ve istediğiniz gibi ayarlayın.'},
    ...
    'QFaceMarker.help.temporal_smoothing':{
        ...
        'tr-TR' : 'Çerçeveler üzerinden ortalama alarak yüz işaret noktalarını stabilize eder.\nStatik sahnelerde veya bir web kamerası ile kullanıma uygundur.'},
    ...
    'QFaceSwapDFM.help.model':{
        ...
        'zh-CN' : '从本地文件夹载入，没有的话可从deepfacelab官方中文论坛dfldata.xyz下载模型文件。\n您可以用 DeepFaceLab 训练自己的模型。',
        ...
        'it-IT' : 'File del modello da una cartella o disponibile per il download da internet.\nPuoi addestrare il tuo modello su DeepFaceLab.',
        ...
        'tr-TR' : 'Bir klasörden model dosyası veya internetten indirilebilir model dosyası.\nKendi modelinizi DeepFaceLab ile eğitebilirsiniz.'},
    ...
    'QFaceSwapDFM.help.face_id':{
        ...
        'tr-TR' : 'Değiştirilecek yüz ID\'si.'},
    ...
    'QFaceSwapDFM.help.morph_factor':{
        ...
        'tr-TR' : 'Kaynak yüzünden ünlüye kadar yüz morf düzeyini kontrol eder.'},
    ...
    'QFaceSwapDFM.help.presharpen_amount':{
        ...
        'tr-TR' : 'Görüntüyü sinir ağlarına girmeden önce keskinleştir.'},
    ...
    'QFaceSwapDFM.help.pregamma':{
        ...
        'tr-TR' : 'Görüntünün gamma değerini, sinir ağına girmeden önce değiştirin.'},
    ...
    'QFaceSwapDFM.help.two_pass':{
        ...
        'tr-TR' : 'Yüzü iki kez işleyin. FPS değeri 2 kat azalır.'},
    ...
    'QFrameAdjuster.help.median_blur_per':{
        ...
        'tr-TR' : 'Tüm çerçeveyi medyan filtre ile bulanıklaştır.'},
    ...
    'QFrameAdjuster.help.degrade_bicubic_per':{
        ...
        'tr-TR' : 'Tüm çerçeveyi bikübik yeniden boyutlandırma ile bozulmasını sağlar.'},
    ...
    'QFaceMerger.face_mask_erode':{
        ...
        'tr-TR' : 'Yüz maskesini erozyona uğrat'},
    ...
    'QFaceMerger.help.color_transfer':{
        ...
        'tr-TR' : 'Değiştirilen yüzün renk dağılımını, orijinal yüzle eşleştir.'},
    ...
    'QStreamOutput.help.avg_fps':{
        ...
        'tr-TR' : 'Çıktı akışının ortalama FPS\'i'},
    ...
    'QStreamOutput.help.target_delay':{
        ...
        'tr-TR' : 'Giriş ve çıkış kareleri arasındaki hedef gecikme süresi milisaniye cinsinden.\nBu değeri akış yazılımınızdaki ses gecikmesiyle eşleştirerek senkronize edilmiş bir akış elde edebilirsiniz.'},
    ...
    'QStreamOutput.help.save_sequence_path':{
        ...
        'tr-TR' : 'Çıktı akışının görsel sırasını belirtilen dizine kaydedin'},
    ...
    'QStreamOutput.help.save_fill_frame_gap':{
        ...
        'tr-TR' : 'Son kareyi çoğaltarak kare boşluklarını doldur'},
    ...
    'StreamOutput.SourceType.SOURCE_N_MERGED_FRAME_OR_SOURCE_FRAME':{
        ...
        'tr-TR' : 'Kaynak ve birleştirilmiş kare veya kaynak kare'}, 
